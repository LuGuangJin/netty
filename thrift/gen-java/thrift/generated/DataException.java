...
public class DataException extends org.apache.thrift.TException implements org.apache.thrift.TBase<DataException, DataException._Fields>, java.io.Serializable, Cloneable, Comparable<DataException> {
  ...
  private static final org.apache.thrift.protocol.TField STACK_CAUSE_FIELD_DESC = new org.apache.thrift.protocol.TField("stackCause", org.apache.thrift.protocol.TType.STRING, (short)2);
  ...
  public java.lang.String stackCause; // required
  public java.lang.String date; // required

  /** The set of fields this struct contains, along with convenience methods for finding and manipulating them. */
  public enum _Fields implements org.apache.thrift.TFieldIdEnum {
    MSG((short)1, "msg"),
    STACK_CAUSE((short)2, "stackCause"),
    DATE((short)3, "date");
  ...
  static {
    ...
    tmpMap.put(_Fields.STACK_CAUSE, new org.apache.thrift.meta_data.FieldMetaData("stackCause", org.apache.thrift.TFieldRequirementType.DEFAULT, 
        new org.apache.thrift.meta_data.FieldValueMetaData(org.apache.thrift.protocol.TType.STRING        , "String")));
  ...
  public DataException(
    ...
    java.lang.String stackCause,
    java.lang.String date)
  {
    this();
    this.msg = msg;
    this.stackCause = stackCause;
    this.date = date;
  }
  ...
  public DataException(DataException other) {
    ...
    if (other.isSetStackCause()) {
      this.stackCause = other.stackCause;
    }
    if (other.isSetDate()) {
  ...
  public DataException setMsg(java.lang.String msg) {
    this.msg = msg;
    return this;
  }
  ...
  public java.lang.String getStackCause() {
    return this.stackCause;
  }

  public DataException setStackCause(java.lang.String stackCause) {
    this.stackCause = stackCause;
    return this;
  }

  public void unsetStackCause() {
    this.stackCause = null;
  }

  /** Returns true if field stackCause is set (has been assigned a value) and false otherwise */
  public boolean isSetStackCause() {
    return this.stackCause != null;
  }

  public void setStackCauseIsSet(boolean value) {
    if (!value) {
      this.stackCause = null;
    }
  }
  ...
  public void setFieldValue(_Fields field, java.lang.Object value) {
    ...
    case STACK_CAUSE:
      if (value == null) {
        ...
        setStackCause((java.lang.String)value);
      }
      break;
  ...
  public boolean equals(DataException that) {
    ...
    boolean this_present_stackCause = true && this.isSetStackCause();
    boolean that_present_stackCause = true && that.isSetStackCause();
    if (this_present_stackCause || that_present_stackCause) {
      if (!(this_present_stackCause && that_present_stackCause))
        return false;
      if (!this.stackCause.equals(that.stackCause))
        return false;
    }
  ...
  public int hashCode() {
    ...
    hashCode = hashCode * 8191 + ((isSetStackCause()) ? 131071 : 524287);
    if (isSetStackCause())
      hashCode = hashCode * 8191 + stackCause.hashCode();
  ...
  public int compareTo(DataException other) {
    ...
    lastComparison = java.lang.Boolean.valueOf(isSetStackCause()).compareTo(other.isSetStackCause());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetStackCause()) {
      lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.stackCause, other.stackCause);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
  ...
  public java.lang.String toString() {
    ...
    first = false;
    if (!first) sb.append(", ");
    sb.append("stackCause:");
    if (this.stackCause == null) {
      sb.append("null");
    } else {
      sb.append(this.stackCause);
    }
    first = false;
    if (!first) sb.append(", ");
    sb.append("date:");
  ...
  private static class DataExceptionStandardScheme extends org.apache.thrift.scheme.StandardScheme<DataException> {
    ...
    public void read(org.apache.thrift.protocol.TProtocol iprot, DataException struct) throws org.apache.thrift.TException {
      ...
      while (true)
      {
        ...
        switch (schemeField.id) {
          ...
          case 2: // STACK_CAUSE
            if (schemeField.type == org.apache.thrift.protocol.TType.STRING) {
              struct.stackCause = iprot.readString();
              struct.setStackCauseIsSet(true);
            } else { 
              org.apache.thrift.protocol.TProtocolUtil.skip(iprot, schemeField.type);
            }
            break;
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, DataException struct) throws org.apache.thrift.TException {
      ...
      if (struct.stackCause != null) {
        oprot.writeFieldBegin(STACK_CAUSE_FIELD_DESC);
        oprot.writeString(struct.stackCause);
        oprot.writeFieldEnd();
      }
      if (struct.date != null) {
