...
public class DataException extends org.apache.thrift.TException implements org.apache.thrift.TBase<DataException, DataException._Fields>, java.io.Serializable, Cloneable, Comparable<DataException> {
  ...
  public String stackCause; // required
  ...
  public DataException setMsg(String msg) {
    this.msg = msg;
    return this;
  }
  ...
  public String getStackCause() {
    return this.stackCause;
  }

  public DataException setStackCause(String stackCause) {
    this.stackCause = stackCause;
    return this;
  }
  ...
  public int compareTo(DataException other) {
    ...
    lastComparison = Boolean.valueOf(isSetStackCause()).compareTo(other.isSetStackCause());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetStackCause()) {
